...
export const createBooking = async (bookingData) => {
  ...
  const newBooking = {
    ...
    passType:     bookingData.passType     || 'DAILY',
    packageId:    bookingData.packageId    || bookingData.passType || '',
    packageName:  bookingData.packageName  || '',
    packagePrice: bookingData.packagePrice || 0,
    hasLocker:    bookingData.hasLocker    || false,
    lockerRequired: bookingData.lockerRequired !== undefined ? bookingData.lockerRequired : (bookingData.hasLocker || false),
    lockerId:     bookingData.lockerId     || null,
...
export const approveBooking = async (bookingId, approvalData = {}) => {
  ...
  const result = await runTransaction(db, async (tx) => {
    ...
    tx.update(bookingRef, {
      ...
      endDate,
      passType,
      packageId:        approvalData.packageId        || booking.packageId        || passType,
      packageName:      approvalData.packageName      || booking.packageName      || '',
      packagePrice:     approvalData.packagePrice     !== undefined ? approvalData.packagePrice : (booking.packagePrice || 0),
      totalAmount,
      amountPaid,
      pendingAmount,
      paymentStatus,
